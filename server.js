...
const authCheck = jwt({
  secret: new Buffer('rzTus1TPOm-b_qmAd4yd9kanj63cLSuLeBnLSgg5JsefwML3gjyLFmWpqXMYFxbv', 'base64'),
  audience: '4YJdXzNCjlIVBUFCv7C5mRYeV3FifNaT'
});

// For the sake of simplicity, we're just mocking out data retrieval here. In an actual application, this data would be queried from a database.
var contacts = [
  {
    id: 1,
